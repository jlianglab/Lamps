...
class ChestX_ray14(Dataset):
  ...
  def __init__(self, pathImageDirectory, pathDatasetFile, augment, epoch, num_class=14, image_size=448, patch_size=32):
  ...
  def __getitem__(self, index):
    ...
    if self.augment != None: imageData = self.augment(imageData, self.epoch)
